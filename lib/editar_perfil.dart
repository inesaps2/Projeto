...
class _EditarPerfilState extends State<EditarPerfil> {
  ...
  String? _getValidInstructorValue(String? currentValue, List<String> instructors) {
    if (currentValue == null || currentValue.isEmpty || currentValue == 'null') {
      return '';
    }
    return instructors.contains(currentValue) ? currentValue : '';
  }
          ...
          children: [
            ElevatedButton(
              onPressed: () {
                ...
                // Controllers fora do builder para manter o estado
                          ...
                          content: Column(
                            ...
                            children: [
                              DropdownButtonFormField<String>(
                                ...
                                onChanged: (value) {
                                  setState(() {
                                    ...
                                    nomeController.text = utilizadorSelecionado?['name']?.toString() ?? '';
                                    categoriaController.text = utilizadorSelecionado?['category']?.toString() ?? '';
                                    final instructorValue = utilizadorSelecionado?['instructor'];
                                    instrutorController.text = (instructorValue != null && instructorValue.toString() != 'null')
                                        ? instructorValue.toString()
                                        : '';
                                    veiculoController.text = utilizadorSelecionado?['associated_car']?.toString() ?? '';
                                  });
                                },
                              ...
                              if (utilizadorSelecionado != null) ...[
                                ...
                                const SizedBox(height: 10),
                                DropdownButtonFormField<String>(
                                  value: _getValidInstructorValue(instrutorController.text, instructors),
                                  decoration: const InputDecoration(
                                    labelText: 'Instrutor',
                                    border: OutlineInputBorder(),
                                  ),
                                  items: [
                                    ...
                                    ...instructors.map<DropdownMenuItem<String>>((String value) {
                                      return DropdownMenuItem<String>(
                                        value: value,
                                        child: Text(value),
                                      );
